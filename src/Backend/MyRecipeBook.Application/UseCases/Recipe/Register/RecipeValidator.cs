    ...
    public class RecipeValidator : AbstractValidator<RequestRecipeJson>
    {
        public RecipeValidator()
        {
            RuleFor(recipe => recipe.Title)
                ...
                .MaximumLength(250)
                .WithMessage(ResourceMessagesException.VALIDATION_TITLE_MAX_LENGHT);

            RuleFor(recipe => recipe.CookTime)
                .IsInEnum()
                .WithMessage(ResourceMessagesException.VALIDATION_COOKIE_TIME_INVALID);
            ...
            RuleForEach(recipe => recipe.Ingredients)
                ...
                .MaximumLength(250)
                .WithMessage(ResourceMessagesException.VALIDATION_INGREDIENT_MAX_LENGHT);
            ...
            RuleForEach(recipe => recipe.Instructions).ChildRules(instruction =>
            {
                ...
                instruction.RuleFor(item => item.Description)
                    ...
                    .MaximumLength(2000)
                    .WithMessage(ResourceMessagesException.VALIDATION_INSTRUCTION_DESCRIPTION_MAX_LENGHT);
            });
